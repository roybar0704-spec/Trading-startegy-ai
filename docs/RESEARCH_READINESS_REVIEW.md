...
| 6 | **סיבה כלשהי שלא להתחיל Backtesting אמיתי?** | בדיקה פתוחה: אנומליות דאטה לא-פתורות, חריגה מהחלטות RA-01–09, שינוי לא-מתועד ב-Rules/RA, כל דגל אדום אחר | שיפוט מפורש, לא רק "אין" כברירת מחדל |

## פסיקה

**GO** רק אם **כל ששת** הסעיפים GO. סעיף אחד NO-GO ⇒ הפסיקה הכוללת NO-GO.
